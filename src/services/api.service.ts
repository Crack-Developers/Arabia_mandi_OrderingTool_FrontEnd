...
export const orderApi = {
  ...
  generateKOT: (id: string, withPrint: boolean = true, allItems?: any[], kotItems?: any[], clientDispatched: boolean = false) => post<any>(`/orders/${id}/kot`, { withPrint, allItems, kotItems, clientDispatched }),
